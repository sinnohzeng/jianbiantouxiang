...
| key                               | zh-CN                                                                                                            |
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `about.intro`                     | 纯前端、不上传、不跟踪。文字、配色与质感都在你的浏览器里渲染成一张图，导出即可用作群聊头像、账号标识或部门徽章。 |
| `about.license`                   | 基于 MIT 许可开源                                                                                                |
| `about.reset`                     | 恢复默认设置                                                                                                     |
...
| `panel.text.color.preset.slate`   | 深灰                                                                                                             |
...
| `reset.body`                      | 文字、配色和全部微调都会回到初始状态，这一步可以撤销。                                                           |
| `reset.cancel`                    | 取消                                                                                                             |
